...
import sudhanva.narayana.cryptick.adapter.UsersChatAdapter;
import sudhanva.narayana.cryptick.login.LoginActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Initialize firebase
        mFirebaseChatRef = new Firebase(Constants.FIREBASE_URL); // Get app main firebase url

        // Get a reference to users child in firebase
        mFireChatUsersRef = new Firebase(Constants.FIREBASE_URL).child(Constants.CHILD_USERS);
    ...
    private void setAuthenticatedUser(AuthData authData) {
        ...
        if (authData != null) {
            ...
            mCurrentUserEmail = (String) authData.getProviderData().get(Constants.KEY_EMAIL);
    ...
    private void queryFireChatUsers() {
        ...
        myConnectionsStatusRef = mFireChatUsersRef.child(mCurrentUserUid).child(Constants.CHILD_CONNECTION);
        ...
        mConnectedListener = mFirebaseChatRef.getRoot().child(".info/connected").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (connected) {
                    ...
                    myConnectionsStatusRef.setValue(Constants.KEY_ONLINE);

                    // When this device disconnects, remove it
                    myConnectionsStatusRef.onDisconnect().setValue(Constants.KEY_OFFLINE);
    ...
    private void logout() {
        ...
        if (this.mAuthData != null) {
            ...
            myConnectionsStatusRef.setValue(Constants.KEY_OFFLINE);
